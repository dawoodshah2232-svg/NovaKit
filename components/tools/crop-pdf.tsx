...
export function CropPdf() {
  ...
  const handleCropAndSave = async () => {
    ...
    try {
      ...
      saveAs(blob, `${baseName}-cropped.pdf`);
        ...
        <div
          ...
          className={`relative rounded-3xl border-2 border-dashed p-8 sm:p-12 text-center transition-all cursor-pointer select-none ${
            isDragActive
              ...
              : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 hover:border-teal-400 dark:hover:border-teal-500 hover:bg-slate-50/50'
          }`}
        >
          <input {...getInputProps()} />
          <div className="max-w-md mx-auto space-y-3">
            <div className="w-16 h-16 rounded-2xl bg-teal-50 dark:bg-teal-950/60 text-teal-600 dark:text-teal-400 flex items-center justify-center mx-auto shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button
              type="button"
              onClick={handleReset}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-teal-600 dark:hover:text-teal-400 transition self-start md:self-auto"
            >
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className="px-2 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-[11px] font-semibold text-slate-700 dark:text-slate-300 hover:bg-teal-50 dark:hover:bg-teal-950/40 hover:text-teal-600 transition"
                  >
                    Reset (0 pt)
                  </button>
                  <button
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-300">
                    ...
                    <span className="font-mono text-teal-600 dark:text-teal-400">{marginTop} pt</span>
                  </div>
                  <input
                    type="range"
                    min={0}
              ...
              <div className="p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                ...
                {activePage && (
                  <div className="relative max-w-sm sm:max-w-md mx-auto aspect-3/4 rounded-2xl overflow-hidden bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center select-none">
                    ...
                    <div
                      className="absolute border-2 border-dashed border-teal-400 shadow-2xl pointer-events-none transition-all flex items-center justify-center"
                      style={{
                        top: `${Math.min(45, topPercent)}%`,
                        bottom: `${Math.min(45, bottomPercent)}%`,
                    ...
                    >
                      <div className="text-[10px] font-bold uppercase tracking-wider bg-teal-600/90 text-white px-2 py-0.5 rounded shadow">
                        Cropped Area
                      </div>
                    </div>
                  </div>
          ...
          <div className="sticky bottom-4 p-4 rounded-3xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-teal-600 hover:bg-teal-700 active:scale-95 text-white font-bold text-sm shadow-md transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isProcessing ? (
                <>
