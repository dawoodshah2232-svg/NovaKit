      ...
      {!loadedPdf ? (
        ...
        >
          ...
          <div className="max-w-md mx-auto space-y-5">
            ...
            <button
              type="button"
              className="min-h-[52px] px-8 py-3.5 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base font-bold shadow-lg shadow-blue-500/25 active:scale-95 transition-all inline-flex items-center gap-2.5 cursor-pointer"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm">
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="w-12 h-12 rounded-2xl bg-blue-100 dark:bg-blue-950/70 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0">
          ...
          <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-6 sm:p-8 shadow-sm space-y-6">
              ...
              {(['extreme', 'recommended', 'less'] as CompressionLevel[]).map((lvlKey) => {
                ...
                return (
                  <button
                    ...
                    className={`p-5 rounded-2xl border text-left transition-all cursor-pointer flex flex-col justify-between gap-4 relative active:scale-[0.99] ${
                      isSelected
                  ...
                  >
                    <div>
                      ...
                      <h5 className="text-base font-extrabold text-slate-900 dark:text-white tracking-tight mb-1">
                        {item.title}
                      </h5>
                    ...
                    <div className="pt-3 border-t border-slate-200/60 dark:border-slate-800 flex items-center justify-between text-xs font-bold">
            ...
            {summary && (
              <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-emerald-50/90 via-teal-50/50 to-emerald-50/90 dark:from-emerald-950/40 dark:via-teal-950/20 dark:to-emerald-950/40 border border-emerald-200/90 dark:border-emerald-800/70 shadow-xs space-y-4 animate-in fade-in">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm font-extrabold text-emerald-900 dark:text-emerald-200">
                      Compression Complete • {summary.fileName}
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-3 text-center pt-1">
                  <div className="p-3 rounded-xl bg-white/80 dark:bg-slate-900/80 border border-emerald-200/60 dark:border-emerald-800/40">
                ...
                <button
                  ...
                  className="w-full min-h-[46px] px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
                >
