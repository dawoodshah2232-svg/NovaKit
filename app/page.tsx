  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between selection:bg-blue-600 selection:text-white">
      <div>
        ...
        <header className="bg-white/95 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold px-2 py-0.5 bg-rose-50 text-rose-600 border border-rose-200 rounded-full uppercase tracking-wider">
                    Studio Suite
                  </span>
                </div>
                <p className="text-[10px] text-slate-500 font-medium">100% Client-Side Private PDF Suite</p>
              </div>
            </div>

            {/* Center: Navigation Links with Icons */}
            <div className="hidden xl:flex items-center gap-6 text-xs font-semibold text-slate-700">
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              <Link 
                href="/cv-builder" 
                className="flex items-center gap-1 bg-emerald-50 text-emerald-700 border border-emerald-200 px-3 py-2 rounded-xl text-xs font-bold hover:bg-emerald-100 transition shadow-2xs"
              >
                <Sparkles className="w-3.5 h-3.5 text-emerald-600" /> AI CV Builder (Free)
              </Link>
              <Link 
                href="/studio" 
                className="bg-blue-600 text-white px-3.5 py-2 rounded-xl text-xs font-bold hover:bg-blue-700 transition shadow-xs flex items-center gap-1"
              >
        ...
        {/* Minimal Search & Hero Section */}
        <section className="bg-white border-b border-slate-200 py-10 px-6 text-center relative overflow-hidden">
