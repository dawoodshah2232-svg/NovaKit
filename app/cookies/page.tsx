...
export const metadata: Metadata = {
  ...
  description:
    'PDFEdit cookie policy: optional consent-based Google Analytics, session storage instead of cookies for first-party analytics, when Google AdSense advertising cookies apply, and how to manage cookies in your browser.',
  alternates: {
  ...
  return (
    <div className='max-w-4xl mx-auto px-4 py-12'>
      ...
      <section className='space-y-4 text-gray-700'>
        ...
        <h2 className='text-xl font-semibold mt-6'>3. Google Analytics (Optional, Consent-Based)</h2>
        <p>We may use Google Analytics (GA4) to understand aggregate usage &mdash; for example, which tools are visited most often &mdash; so we can decide what to improve. Analytics is <strong>off by default</strong> and only activates after you click &quot;Accept analytics&quot; in the cookie notice.</p>
        <ul className='list-disc list-inside space-y-1 ml-2'>
          <li><strong>Consent Mode:</strong> until you accept, Google&apos;s analytics storage stays denied and no analytics data is collected.</li>
          <li><strong>What is collected:</strong> standard anonymous page-view events (page path and approximate device/browser information). We never send file names, document contents, or anything you type into the tools.</li>
          <li><strong>IP anonymization:</strong> enabled &mdash; Google does not store your full IP address for this property.</li>
          <li><strong>Your choice persists</strong> in your browser&apos;s local storage. You can change it at any time via &quot;Cookie Settings&quot; in the site footer, or install Google&apos;s <a href='https://tools.google.com/dlpage/gaoptout' target='_blank' rel='noopener noreferrer' className='text-blue-600 underline'>opt-out browser add-on</a>.</li>
        </ul>
        <p>How Google uses data from sites that use its services is explained at <a href='https://policies.google.com/technologies/partner-sites/' target='_blank' rel='noopener noreferrer' className='text-blue-600 underline'>policies.google.com/technologies/partner-sites/</a>.</p>

        <h2 className='text-xl font-semibold mt-6'>4. Third-Party Advertising Cookies</h2>
        ...
        <h2 className='text-xl font-semibold mt-6'>5. Opting Out of Advertising Cookies</h2>
        ...
        <h2 className='text-xl font-semibold mt-6'>6. What We Do Not Set</h2>
        <ul className='list-disc list-inside space-y-1 ml-2'>
        ...
        <h2 className='text-xl font-semibold mt-6'>7. How to Manage Cookies in Your Browser</h2>
        ...
        <h2 className='text-xl font-semibold mt-6'>9. Related Policies &amp; Contact</h2>
