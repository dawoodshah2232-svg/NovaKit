...
export const metadata: Metadata = {
	...
	twitter: { card: 'summary_large_image', title: 'Rotate PDF Pages Online Free | PDFEdit', description: 'Rotate PDF pages in your browser and download the adjusted document locally.' },
};
