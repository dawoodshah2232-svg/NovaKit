...
export const metadata: Metadata = {
	...
	twitter: { card: 'summary_large_image', title: 'Unlock PDF Online and Remove Password Restrictions | PDFEdit', description: 'Remove supported PDF password restrictions locally in your browser.' },
};
